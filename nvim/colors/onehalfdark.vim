...
" Popup complete menu
call s:h("Pmenu", s:fg, s:vertsplit, "")
...
highlight MyModeColor guifg=s:fg guibg=s:blue
highlight MyStatusColor guifg=s:fg guibg=s:bg
" TODO: Why do I need to do this to get the right colors when launching?
call s:h("MyModeColor", s:fg, s:blue, "")
call s:h("MyStatusColor", s:fg, s:bg, "")
" normal
autocmd ModeChanged *:n call s:h("MyModeColor", s:fg, s:blue, "")
" insert
autocmd ModeChanged *:i call s:h("MyModeColor", s:fg, s:green, "")
" visual visual-line
autocmd ModeChanged *:[vV] call s:h("MyModeColor", s:fg, s:purple, "")
" visual-block
autocmd ModeChanged *:\v() call s:h("MyModeColor", s:fg, s:yellow, "")
" command
autocmd ModeChanged *:c call s:h("MyModeColor", s:fg, s:cyan, "")
" replace
autocmd ModeChanged *:\v(r|R) call s:h("MyModeColor", s:fg, s:red, "")
" select
autocmd ModeChanged *:\v(s|S|) call s:h("MyModeColor", s:fg, s:red, "")
" terminal
autocmd ModeChanged *:t call s:h("MyModeColor", s:fg, s:red, "")
